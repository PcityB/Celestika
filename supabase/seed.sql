...
VALUES
  ...
  (
    ...
    'Symbolizes taking control of one' s own life
...
from
  ...
  and freedom.', ' Represents the encounter with one 's inner demons and the struggle between desire and liberation.'
),
(
  'major16',
  'The Tower',
...
(
  ...
  'Represents the process of self-assessment and understanding one' s place in the larger cosmic order.'), (' major21 ', ' The World ', ' Major ', ' 21 ', ' completion,
  fulfillment,
  wholeness,
...
(
  ...
  'Represents the encounter with love and the power of choices that shape one' s path.'), (' major7 ', ' The Chariot ', ' Major ', ' 7 ', ' determination,
  victory,
  willpower,
  ...
  from
    ...
    and the ability to control one 's destiny.'
),
(
  'major8',
  'Strength',
  ...
  'Strength symbolizes inner power and the gentle control of one' s impulses.It encourages you to face challenges with compassion
  and self - confidence.', '
  When reversed,
  Strength can indicate self - doubt
  or an inability to manage one 's emotions. It calls for patience and self-acceptance.',
  'Represents the encounter with inner strength and the lesson of mastering one' s emotions.'), (' major9 ', ' The Hermit ', ' Major ', ' 9 ', ' introspection,
  soul - searching,
  solitude,
